  ...
  return (
    <main className={styles.policy}>
      <header className={styles.hero}>
        <h2>개인정보처리방침</h2>
        <p>
          BRIDGE Labs.(이하 “회사”)는 이용자의 개인정보를 소중히 다루며, 관련 법령을
          준수합니다. 본 방침은 회사가 제공하는 서비스에서 어떤 정보를 수집하고
          어떻게 사용하며 보호하는지에 대해 안내합니다.
        </p>
      ...
      <section className={styles.section}>
        ...
        <p className={styles.note}>
          회사는 회원가입이나 결제 기능을 제공하지 않으며, 이메일 문의를 통해서만
          개인정보가 전달될 수 있습니다.
        </p>
      </section>
      ...
      <section className={styles.section}>
        ...
        <p>
          회사는 원칙적으로 개인정보를 제3자에게 제공하지 않습니다. 다만, 안정적인
      ...
      <section className={styles.section}>
        <h3>6. 쿠키 및 로그 정보</h3>
        <p>
          회사는 원활한 운영과 보안을 위해 쿠키 및 접속 로그를 사용할 수 있습니다.
      ...
      <section className={styles.section}>
        ...
        <p>
          회사는 개인정보 보호를 위해 접근 통제, 암호화 통신(HTTPS), 내부 관리
